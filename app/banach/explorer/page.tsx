...
const EXPLORER: Record<Locale, RichExplorer> = {
  en: {
    ...
    overlayMsg: (h, inv) => `W(${h}) shifted by ${inv} covers F₂ ∖ W(${h})`,
  ...
  de: {
    ...
    overlayMsg: (h, inv) => `W(${h}) verschoben um ${inv} überdeckt F₂ ∖ W(${h})`,
    overlaySubMsg:
  ...
  es: {
    ...
    overlayMsg: (h, inv) => `W(${h}) desplazada por ${inv} cubre F₂ ∖ W(${h})`,
  ...
  fr: {
    ...
    overlayMsg: (h, inv) => `W(${h}) décalée de ${inv} recouvre F₂ ∖ W(${h})`,
  ...
  it: {
    ...
    overlayMsg: (h, inv) => `W(${h}) traslato di ${inv} copre F₂ ∖ W(${h})`,
  ...
  pt: {
    ...
    overlayMsg: (h, inv) => `W(${h}) deslocada por ${inv} cobre F₂ ∖ W(${h})`,
  ...
  sv: {
    ...
    overlayMsg: (h, inv) => `W(${h}) förskjuten med ${inv} täcker F₂ ∖ W(${h})`,
  ...
  no: {
    ...
    overlayMsg: (h, inv) => `W(${h}) forskjøvet med ${inv} dekker F₂ ∖ W(${h})`,
