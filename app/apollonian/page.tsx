...
const sv: RichStory = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Heltalskrökningarna i en apolloniansk packning bildar en mängd naturliga tal — men vilka dyker upp? Den lokal-globala förmodan säger: en krökning dyker upp i en given packning om och endast om den dyker upp modulo 24 i den — på en ändlig lista undantag när. Bourgain och Fuchs bevisade 2011 att heltalskrökningarna har positiv täthet: en fix positiv andel av alla heltal dyker faktiskt upp. Bakom lever en djupare historia — varje apolloniansk packning är banan för en grupp av Lorentzspeglingar på en kvadratisk form av signatur (3,1), och samma packningar dyker upp igen som ränder till hyperboliska 3-mångfalder. Geometri, talteori och gruppteori möts i en bild av cirklar som rör vid varandra.",
    },
  ],
  descartes: {
...
const no: RichStory = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Heltallskrumningene i en apollonsk pakning danner en mengde naturlige tall — men hvilke dukker opp? Den lokal-globale formodningen sier: en krumning dukker opp i en gitt pakning hvis og bare hvis den dukker opp modulo 24 i den — på en endelig liste unntak nær. Bourgain og Fuchs viste i 2011 at heltallskrumningene har positiv tetthet: en fast positiv andel av alle heltall dukker virkelig opp. Bak lever en dypere historie — hver apollonsk pakning er banen til en gruppe av Lorentz-refleksjoner på en kvadratisk form av signatur (3,1), og de samme pakningene dukker opp igjen som rander til hyperbolske 3-mangfoldigheter. Geometri, tallteori og gruppeteori møtes i et bilde av sirkler som tar på hverandre.",
    },
  ],
  descartes: {
