...
const en: RichStory = {
  ...
  fibonacci: {
    ...
    ratioHeader: "Fₙ₊₁ / Fₙ",
    diffHeader: "ratio − φ",
    hint: "The error alternates sign and shrinks by ≈|ψ/φ|² ≈ 0.146 each step — a clean geometric convergence. The spiral on the right is built from the first few Fibonacci squares.",
...
const de: RichStory = {
  ...
  fibonacci: {
    ...
    hint: "Der Fehler wechselt das Vorzeichen und schrumpft pro Schritt um ≈|ψ/φ|² ≈ 0,146 — eine saubere geometrische Konvergenz. Die Spirale rechts entsteht aus den ersten Fibonacci-Quadraten.",
...
const es: RichStory = {
  ...
  fibonacci: {
    ...
    ratioHeader: "Fₙ₊₁ / Fₙ",
    diffHeader: "razón − φ",
    hint: "El error alterna de signo y encoge en ≈|ψ/φ|² ≈ 0,146 a cada paso — una convergencia geométrica limpia. La espiral de la derecha sale de los primeros cuadrados de Fibonacci.",
...
const fr: RichStory = {
  ...
  fibonacci: {
    ...
    hint: "L'erreur change de signe et rétrécit d'environ |ψ/φ|² ≈ 0,146 à chaque pas — une convergence géométrique nette. La spirale à droite est faite des premiers carrés de Fibonacci.",
...
const it: RichStory = {
  ...
  fibonacci: {
    ...
    hint: "L'errore alterna segno e si restringe di ≈|ψ/φ|² ≈ 0,146 a ogni passo — una convergenza geometrica pulita. La spirale a destra nasce dai primi quadrati di Fibonacci.",
...
const pt: RichStory = {
  ...
  fibonacci: {
    ...
    ratioHeader: "Fₙ₊₁ / Fₙ",
    diffHeader: "razão − φ",
    hint: "O erro troca de sinal e encolhe ≈|ψ/φ|² ≈ 0,146 a cada passo — uma convergência geométrica limpa. A espiral à direita nasce dos primeiros quadrados de Fibonacci.",
...
const sv: RichStory = {
  ...
  fibonacci: {
    ...
    ratioHeader: "Fₙ₊₁ / Fₙ",
    diffHeader: "kvot − φ",
    hint: "Felet växlar tecken och krymper med ≈|ψ/φ|² ≈ 0,146 per steg — en ren geometrisk konvergens. Spiralen till höger byggs av de första Fibonacci-kvadraterna.",
...
const no: RichStory = {
  ...
  fibonacci: {
    ...
    hint: "Feilen veksler fortegn og krymper med ≈|ψ/φ|² ≈ 0,146 per steg — en ren geometrisk konvergens. Spiralen til høyre er bygget av de første Fibonacci-kvadratene.",
