...
const de: RichStory = {
  ...
  spiral: {
    ...
    body: "Ein erregbares Medium hat nur zwei Zustände: Ruhe und kurze Erregung, getrennt durch eine refraktäre Welle. Schick eine Welle hindurch, und sie läuft ohne Dispersion. Brich eine einzelne Wellenfront, und das offene Ende rollt sich ein — das ist die universelle Form, auf die sich jedes erregbare Medium einpendelt, von einer Petrischale bis zu einem flimmernden Herzventrikel.",
  },
...
const no: RichStory = {
  ...
  spiral: {
    ...
    body: "Et eksiterbart medium har bare to tilstander: hvile og kort eksitering, atskilt av en refraktær hale. Send en bølge gjennom det, og den forplanter seg uten dispersjon. Bryt én bølgefront, og den åpne enden ruller seg sammen — det er den universelle formen ethvert eksiterbart medium ender i, fra en petriskål til et flimrende hjertekammer.",
  },
