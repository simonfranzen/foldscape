...
const fr: RichStory = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "En 1901 le mathématicien italien Mario Lazzarini publia une expérience où il prétendait avoir calculé π ≈ 3,1415929 à partir de seulement 3408 lancers d'aiguille — six chiffres corrects, en accord exact avec la célèbre approximation chinoise 355 / 113. Une telle précision avec un essai de Buffon exigerait de l'ordre de 10¹⁰ lancers par convergence honnête. L'astuce : 355 / 113 = 113 / 71 · (5/2), et le plan de Lazzarini utilisa N = 213 · 16 = 3408 et un rapport aiguille-ligne de 5/6, choisi pour que, au moment où le compteur courant atteignait 1808 croisements, l'estimateur tombe sur 355 / 113 par construction. Il s'est arrêté presque à coup sûr au bon moment. L'épisode est célèbre comme le récit-avertissement le plus net en statistique expérimentale — et comme preuve que l'aiguille de Buffon, conduite honnêtement, converge atrocement lentement. Pierre-Simon Laplace avait déjà étendu le problème en 1812 à une grille carrée de lignes, où deux croisements (horizontal et vertical) peuvent être comptés indépendamment et la variance est divisée par deux ; la variante de Laplace est celle qu'un expérimentateur sérieux ferait vraiment tourner.",
    },
    {
...
const sv: RichStory = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "År 1901 publicerade den italienske matematikern Mario Lazzarini ett experiment där han hävdade att han hade beräknat π ≈ 3,1415929 från endast 3408 nålsläpp — sex korrekta siffror, i exakt överensstämmelse med den berömda kinesiska approximationen 355 / 113. Den noggrannheten ur ett Buffon-försök skulle kräva i storleksordningen 10¹⁰ släpp vid ärlig konvergens. Tricket: 355 / 113 = 113 / 71 · (5/2), och Lazzarinis upplägg använde N = 213 · 16 = 3408 och ett nål-till-linje-förhållande på 5/6 valt så att, i det ögonblick det pågående räknet råkade hamna på 1808 korsningar, skattaren landade på 355 / 113 per konstruktion. Han stannade nästan säkert i rätt ögonblick. Episoden är ökänd som den renaste varningssagan i experimentell statistik — och som bevis för att Buffons nål, ärligt genomförd, konvergerar plågsamt långsamt. Pierre-Simon Laplace hade redan 1812 utvidgat problemet till ett kvadratiskt rutnät av linjer, där två korsningar (horisontell och vertikal) kan räknas oberoende och variansen halveras; Laplaces variant är den en seriös experimentör faktiskt skulle köra.",
    },
    {
