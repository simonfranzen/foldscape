...
const RICH_STORY: Record<Locale, RichStory> = {
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Below r = 3 the iteration always settles to one steady population — a fixed point. Push r just past 3 and the fixed point stops being stable: instead the orbit jumps every year between a higher value and a lower value. The dot has become a 2-cycle. This is a period-doubling bifurcation, the simplest way a steady state can give way to oscillation, and it is the first crack in the calm.",
      },
      {
    ...
    timeSeriesCaption: "Time series · xₙ",
  ...
  de: {
    ...
    timeSeriesCaption: "Zeitreihe · xₙ",
    rAriaLabel: "Wachstumsrate r",
  ...
  es: {
    ...
    timeSeriesCaption: "Serie temporal · xₙ",
    rAriaLabel: "Tasa de crecimiento r",
  ...
  fr: {
    ...
    timeSeriesCaption: "Série temporelle · xₙ",
    rAriaLabel: "Taux de croissance r",
  ...
  it: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Sotto r = 3 l'iterazione si assesta sempre su una sola popolazione stabile — un punto fisso. Spingi r appena oltre 3 e il punto fisso perde stabilità: l'orbita salta ogni anno fra un valore alto e uno basso. Il punto è diventato un 2-ciclo. È una biforcazione con raddoppio di periodo, il modo più semplice in cui uno stato stabile lascia il posto all'oscillazione, ed è la prima crepa nella calma.",
      },
      {
      ...
      },
      {
        ...
        body: "Dopo infinite duplicazioni, tutte schiacciate in una finestra finita di r, il sistema cade infine nel caos al punto di Feigenbaum r∞ ≈ 3,56994567… Oltre, l'orbita non si assesta più su alcun ciclo — visita un insieme infinito di valori, e due punti di partenza distanti 10⁻⁶ diventano scorrelati in trenta iterazioni. A r = 4 la mappa è coniugata alla mappa tenda su [0,1]: pura casualità deterministica, generata da una riga di aritmetica.",
      },
      {
    ...
    timeSeriesCaption: "Serie temporale · xₙ",
    rAriaLabel: "Tasso di crescita r",
  ...
  pt: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Abaixo de r = 3 a iteração assenta sempre numa única população estável — um ponto fixo. Empurra r logo acima de 3 e o ponto fixo perde estabilidade: a órbita salta cada ano entre um valor alto e um baixo. O ponto tornou-se num 2-ciclo. É uma bifurcação por duplicação de período, a maneira mais simples de um estado estável dar lugar à oscilação, e é a primeira fissura na calma.",
      },
      {
    ...
    timeSeriesCaption: "Série temporal · xₙ",
    rAriaLabel: "Taxa de crescimento r",
  ...
  sv: {
    ...
    demoCaption2: "Känsligt beroende · två banor, ε ifrån varandra",
    timeSeriesCaption: "Tidsserie · xₙ",
    rAriaLabel: "Tillväxttakt r",
  ...
  no: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Under r = 3 lander iterasjonen alltid på én enkelt stabil populasjon — et fastpunkt. Skyv r så vidt over 3 og fastpunktet mister stabiliteten: banen hopper i stedet hvert år mellom en høy og en lav verdi. Punktet er blitt til en 2-syklus. Det er en periodedoblingsbifurkasjon, den enkleste måten en stabil tilstand gir plass til svingning på, og det er den første sprekken i roen.",
      },
      {
        pretitle: "Steg tre · Kaskaden",
      ...
      <section className="mx-auto mb-32 max-w-4xl space-y-6">
        ...
        <Reveal delay={120}>
          <div className="space-y-2">
            ...
            <LogisticRTimeSeries
              caption={story.timeSeriesCaption}
              cobwebCaption={story.cobwebCaption}
              rAriaLabel={story.rAriaLabel}
              initialR={3.1}
            />
          </div>
        </Reveal>
